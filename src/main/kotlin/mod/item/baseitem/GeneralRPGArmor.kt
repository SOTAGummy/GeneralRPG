...
open class GeneralRPGArmor(name: String, material: ArmorMaterial?, ArmorSlot: EntityEquipmentSlot, rarity: SkillRarity, includeEvents: Boolean = false) : ItemArmor(material!!, 0, ArmorSlot) {
	init {
		this.maxStackSize = 1
