...
object ElectricLeggings :
	GeneralRPGArmor("electric_leggings", ArmorType.ElectricArmor, EntityEquipmentSlot.LEGS, ItemRarity.EPIC) {
	override fun getAttributeModifiers(
		...
		if (slot == EntityEquipmentSlot.LEGS) {
			multimap.put(
				...
				AttributeModifier(ARMOR_MODIFIERS[equipmentSlot.index], "knockbackregistance", 0.5, 0)
			)
			multimap.put(
