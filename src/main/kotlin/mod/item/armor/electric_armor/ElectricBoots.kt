...
object ElectricBoots :
	GeneralRPGArmor("electric_boots", ArmorType.ElectricArmor, EntityEquipmentSlot.FEET, ItemRarity.EPIC) {
	override fun getAttributeModifiers(
		...
		if (slot == EntityEquipmentSlot.FEET) {
			multimap.put(
				SharedMonsterAttributes.MOVEMENT_SPEED.name,
				AttributeModifier(ARMOR_MODIFIERS[equipmentSlot.index], "move", 0.05, 0)
			)
			multimap.put(
